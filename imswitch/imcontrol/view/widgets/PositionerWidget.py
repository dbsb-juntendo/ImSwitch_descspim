...
class PositionerWidget(Widget):
    ...
    #sigsetSpeedClicked = QtCore.Signal()  # (speed)        # why removed?
    sigStepAbsoluteClicked = QtCore.Signal(str, str) # absolute movement?
    #TODO homing
    #TODO stopping
    ...
    def addPositioner(self, positionerName, axes):#, hasSpeed):
        for i in range(len(axes)):
            ...
            #if hasSpeed:
            #    self.pars['Speed' + parNameSuffix] = QtWidgets.QLabel(f'Speed: <strong>{0:.2f} µm/s</strong>')
