            ...
            for (int i = 0; i < max_sequence; i++) {
               ...
               delay(exposure_time/2);        
                  ...
                  {  
                     ...
                     //Serial.println(sizeof(laserPins));
                     if (move_stage < sizeof(laserPins)/sizeof(laserPins[0]) - 1) {
                        Serial.println("stage movement not needed");
                        Serial.println(move_stage);
                        move_stage = move_stage + 1;
                        Serial.println(move_stage);
                        Serial.println("end_of_print_no_stage");
                     }   
                     else {                        
                        Serial.println("trigger stage movement");
                        Serial.println(move_stage);
                        Serial.println(laserPins[0]);
                        ...
                        //TODO make faster by asking stage input movement stop
                     ...
                     delay(200);       // why is this delay here???
